...
/* ======================================================
   AI Assistant Button - Show on Scroll + Full Functionality
====================================================== */
...
// إخفاء الزر في البداية + تأثير انتقال ناعم
if (aiAssistantBtn) {
...
// إظهار/إخفاء الزر بناءً على السكرول
window.addEventListener('scroll', () => {
    if (window.scrollY > 100) {  // غير الـ 300 لو عايز يظهر أسرع أو أبطأ
...
if (aiAssistantBtn && aiPopup) {
    aiAssistantBtn.addEventListener('click', (e) => {
        e.stopPropagation();  // عشان ما يتقفلش لو ضغطت على الزر
...
if (sendMessage && chatInput) {
    const sendUserMessage = () => {
        ...
        }, 800 + Math.random() * 700);  // تأخير طبيعي شوية
    };
...
function appendMessage(text, className) {
    ...
    chatBody.scrollTop = chatBody.scrollHeight;  // Auto scroll لآخر رسالة
}

// 3D Tilt Effect بـ Vanilla Tilt (احترافي جدًا)
